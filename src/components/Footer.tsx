...
const Footer: React.FC = () => {
  return (
    <footer className="relative bg-moleculens-darker pt-16 pb-8 border-t border-white/10">
      <div className="container mx-auto container-padding">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <Headset className="h-6 w-6 text-moleculens-primary" />
              <h3 className="text-xl font-bold">
                <span className="gradient-text">Molecu</span>Lens XR
              </h3>
            </div>
            <p className="text-white/70 mb-4 max-w-md">
              Experience molecules in augmented reality directly in your browser.
              No app downloads, no special hardware required - just pure immersive science.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-white/70 hover:text-moleculens-primary transition-colors">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/50 text-sm">
            &copy; {new Date().getFullYear()} MolecuLens XR. All rights reserved.
          </p>
